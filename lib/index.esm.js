...
var isEmpty = function (val) {
    ...
    if (isArray$1(val) || isString$2(val)) {
        return val.length === 0;
    }
...
var isPromise = function (val) {
    return is(val, "Promise") && isObject$1(val) && isFunction$2(val.then) && isFunction$2(val.catch);
};
...
export { assign, base64ImgPrefix, index$5 as dateUtil, deepAssign, deepCopy, index$4 as desensitizeUtil, desensitizeValue, downLoadFile, filterTree, findIdItem, findIdName, forEachTree, getDateMoment, getDateStr, getOrdinalKey, getOrgName, getTreeLink, getTreeMap, getUrlQuery, getValueByExpression, is, isArray$1 as isArray, isBoolean$1 as isBoolean, isClient, isDark, isDate$1 as isDate, isDef, isElement, isEmpty, isEmptyVal, isFunction$2 as isFunction, isImgPath, isMap, isNotEmpty, isNull, isNullAndUnDef, isNullOrUnDef, isNumber$1 as isNumber, isObjEmpty, isObjNotEmpty, isObject$1 as isObject, isPromise, isRegExp$1 as isRegExp, isServer, isString$2 as isString, isTimestamp, isUnDef, isUrl, index$3 as isUtil, isWindow, local, objToQueryString, index$2 as objectUtil, session, index$1 as storageUtil, timesToStamp, timestampToTime, index as toolUtil };
